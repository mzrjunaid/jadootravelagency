...
const Topsellings = () => {
  return (
    <Container id="Destinations" className="selling section p-5 mb-5">
      <Row>
        <Col className="sec-title-container  mb-5 text-center">
          <h6 className="sec-subtitle fs-5 lh-base fw-semibold text-captalize">
            Top Selling
          </h6>
      ...
      <Row className="grid gap-5 row-gap-5">
        <Col style={{ zIndex: 1 }}>
